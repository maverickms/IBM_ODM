...
--><connector xmlns:j2ee="http://java.sun.com/xml/ns/j2ee" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns="http://java.sun.com/xml/ns/j2ee" xsi:schemaLocation="http://java.sun.com/xml/ns/j2ee http://java.sun.com/xml/ns/j2ee/connector_1_5.xsd" version="1.5">
        ...
        <resourceadapter-version>Decision Server 8.9.2.0</resourceadapter-version>

        <license>

                <description>
                        Licensed Materials - Property of IBM (c) Copyright
                        IBM Corp. 1987, 2018 All Rights Reserved US Government Users
...
<config-property-name>plugins</config-property-name>
<config-property-type>java.lang.String</config-property-type>
<config-property-value>{pluginClass=Management,xuName=default,protocol=jmx}</config-property-value>
</config-property>
